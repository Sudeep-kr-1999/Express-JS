...
// query string logic:---- 
// note:--- for query string url :http://localhost:5000/api/v1/query?name=sudeep&id=3
// output:----- { name: 'sudeep', id: '3' }
app.get("/api/v1/query", (req, res) => {
    ...
    // note:----- if we want to put json in the response in the web under if condition we have to explicitly return that (very imp! )
    //    because we cannot set multiple response for a single query so we must return when we have done 
